...
import com.example.fuentes.ui.theme.TipCalculatorTheme
...
fun TipTimeLayout() {
    ...
    Column(
        ...
        CustomTipValue(
            R.string.tip_label, KeyboardOptions.Default.copy
                (
...
@Composable
fun CustomTipValue(@StringRes label: Int, keyboardOptions: KeyboardOptions, value: String, onValueChange: (String) -> Unit, modifier: Modifier = Modifier) {
    TextField(
        value = value,
...
@Composable
fun RoundTip(roundUp: Boolean, onRoundUpChanged:(Boolean) -> Unit, modifier: Modifier = Modifier) {
    Row(
        modifier = modifier
            .fillMaxWidth()
            .size(48.dp),
